...
/*   Updated: 2020/01/07 19:20:58 by pbesson     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int		main(void)
{
	...
	count = ft_check_return(mine, real, count);
	printf("\n\n\\*/--------------------------------\\*\n\n");
	printf("\033[0;34m     test : |%%-*.5d|\033[00m\n\n");
	...
	count = ft_check_return(mine, real, count);
	printf("\n\n\\*/--------------------------------\\*\n\n");
	printf("\033[0;34m     test : |%%--0--0--00-00-02.10%%|\033[00m\n\n");
	mine = ft_printf("\nft_printf : |%--0--0--00-00-02.10%|");
    real = printf("\n   printf : |%--0--0--00-00-02.10%|");
	count = ft_check_return(mine, real, count);
	printf("\n\n\\*/--------------------------------\\*\n\n");
